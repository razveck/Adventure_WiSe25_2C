...
public class Player : MonoBehaviour {
	...
	void Update() {
		...
		//nur f�r feste Kamera!!!
		//wenn wir die "Move" Taste dr�cken, �bernimmt das Reference Object die Camera Rotation
	...
	private void OnTriggerEnter(Collider other) {
		...
		if(interactable != null) //wenn es nicht null ist, haben wir auf jeden Fall ein Interactable ber�hrt
